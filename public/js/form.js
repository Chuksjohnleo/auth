document.addEventListener("DOMContentLoaded", () => {
  ...
  const eyeOff = `
    <svg width="20" height="20" viewBox="0 0 24 24" class="fill-primary-color">
      <path
  ...
  showPassBtn.addEventListener("click", (e) => showPass(e));
  showPassBtn.innerHTML = eyeOpen;

  function showPass(e) {
    const passwordInput = document.getElementById("password");
    if (passwordInput.type === "password") {
      passwordInput.type = "text";
      showPassBtn.innerHTML = eyeOff;
    } else {
